...
from app.books.db import add_to_db, delete_to_db, update_to_db
from app.books.models import BookModel
from app.books.schemas import Book, BookAdd, BookDelete, BookUpdate
...
def delete_to_book(
    ...
    return {"Удалено": {"name": data_book.name}}
